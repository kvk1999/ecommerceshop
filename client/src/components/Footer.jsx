...
export default function Footer() {
  return (
    <footer className="mt-16 rounded-[2rem] border border-slate-200/20 bg-white/80 px-8 py-10 text-slate-700 shadow-2xl shadow-slate-900/10 backdrop-blur-xl dark:border-white/10 dark:bg-slate-950/55 dark:text-slate-300">
      ...
      <div className="mt-10 border-t border-slate-200/40 pt-6 text-center text-sm text-slate-500 dark:border-white/10 dark:text-slate-500">

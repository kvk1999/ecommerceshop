        ...
        <div className="flex items-center gap-6">
          ...
          <Link to="/" className="flex items-center">
            <img
              src={logoSrc}
              alt="ShopSphere logo"
              className="h-16 w-[220px] rounded-2xl border border-slate-200/30 bg-white object-contain px-4 py-2 shadow-lg dark:border-white/10 dark:bg-slate-950/70"
            />
          </Link>
